      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ color: "#64748b", fontSize: "0.95rem", margin: 0 }}>
            Register to save and reopen your chat history.
          </p>
        </div>
        ...
        <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          {status && (
            <div style={{ padding: "10px 14px", borderRadius: 8,
              background: status.toLowerCase().includes("creat") ? "#f0fdf4" : "#fff5f5",
              border: `1px solid ${status.toLowerCase().includes("creat") ? "#bbf7d0" : "#fecaca"}`,
              color: status.toLowerCase().includes("creat") ? "#15803d" : "#dc2626",
              fontSize: "0.875rem" }}>
              {status}
            </div>
          )}
